...
export REPORT_FILE_NFTABLES="report_tests_nftables.txt"
export REPORT_FILE_SNORT="report_tests_snort.txt"
...
# Alias per compatibilità con run_audit_snort.sh (nomi TARGET_*)
...
# Alias per run_audit_snort.sh (nomi PORT_*)
